...
% !TeX document-id = {38a8da30-71fd-4302-9814-e0e9b914c974}
% !TeX encoding = utf8
% !TeX program = xelatex
% 中文：文件utf8，文档utf8（默认），引入相应的包、类，以及xelatex
% 英文:默认pdflatex即可
% 上面这些都是特殊的注释格式，还有比如：
% TODO
% FIXME
...
%\usepackage{ctex}
% -全局中文化
%  直接使用 {ctexart} 的文档类而不是 {article} 
%  可以指定[hyperref]选项以避免可能的中文链接乱码
%  即在Tex开头部分使用：\documentclass[hyperref]{ctexart}
...
% 原著Chaitanya Krishna Ande，并由3个好心人修改。
